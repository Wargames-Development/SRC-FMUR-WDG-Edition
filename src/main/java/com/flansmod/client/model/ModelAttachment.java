...
public class ModelAttachment extends ModelBase 
{
	...
	/** 组合镜 */
	public float coSightRenderOffset = 0.0F;
	...
	public void flipAll()
	{
		...
		for (ModelRendererTurbo z : zDepthModel)
		{
			z.doMirror(false, true, true);
			z.setRotationPoint(z.rotationPointX, -z.rotationPointY, -z.rotationPointZ);
		}
	}
}
