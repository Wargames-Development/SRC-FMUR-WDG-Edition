...
public class ModelAW50 extends ModelGun {
    public ModelAW50() {
        ...
        gunModel[0].addObj("/BFMCpack/aw50.obj");
        gunModel[0].setRotationPoint(3.5F, 2.0F, 0.0F);
        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        ammoModel[0].addObj("/BFMCpack/aw50mag.obj");
        ammoModel[0].setRotationPoint(3.5F, 2.0F, 0.0F);
        pumpModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        pumpModel[0].addObj("/BFMCpack/aw50_cock.obj");
        pumpModel[0].setRotationPoint(3.5F, 2.0F, 0.0F);
