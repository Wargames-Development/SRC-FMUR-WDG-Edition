...
public class ModelRAMPAGE_LMG extends ModelGun {

    public ModelRAMPAGE_LMG() {
        ...
        gunModel[0].addObj("/BFMCpack/rampage_lmg/rampage_lmg_gun.obj");
        gunModel[0].setRotationPoint(0.0F, 0.0F, 0.0F);

        ammoModel = new ModelRendererTurbo[1];
        ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        ammoModel[0].addObj("/BFMCpack/rampage_lmg/rampage_lmg_ammo.obj");
        ammoModel[0].setRotationPoint(0.0F, 0.0F, 0.0F);

        barrelAttachPoint = new Vector3f(167.06F / 16F, 45.25F / 16F, 0F / 16F);
        scopeAttachPoint = new Vector3f(34F / 16F, 52.66F / 16F, 0F / 16F);
        gadgetAttachPoint = new Vector3f(85F / 16F, 45.72F / 16F, -8.88F / 16F);
        gripAttachPoint = new Vector3f(79.37F / 16F, 16.21F / 16F, 0F / 16F);
