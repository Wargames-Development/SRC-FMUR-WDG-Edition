...
import com.flansmod.client.model.animation.gltf.AnimationResourceHandler;
...
import com.flansmod.common.mob.RenderSoldier;
...
public class ClientProxy extends CommonProxy {
    ...
    public void registerRenderers() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityConnectingLine.class, new RenderConnectingLine());
        ...
        FlansMod.log("Registered renderers.");
    }
    ...
    @Override
    public void loadAnimation(String key, String path) {
        AnimationResourceHandler.addAnimationFile(key, path);
    }
        ...
        if (mc.renderViewEntity != null && mc.effectRenderer != null) {
            ...
            if (entityfx != null) {
                ...
                if (d6 * d6 + d7 * d7 + d8 * d8 > d9 * d9) {
                    ...
                    } else if (p_72726_1_.equals("flansmod.rocketexhaust")) { //大烟雾
                        entityfx = new EntityRocketexhaust(theWorld, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_);
                    } else if (p_72726_1_.equals("flansmod.missiletrail")) { //导弹航迹云
                        entityfx = new EntityCloudFX2(theWorld, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, 120);
                    }
