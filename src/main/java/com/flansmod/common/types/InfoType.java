...
public abstract class InfoType implements IInfoType {
    ...
    public boolean useGLTFAnimation = false;
    public boolean useRightArmGLTFAnimation = false;
    public boolean useLeftArmGLTFAnimation = false;
    public String gLTFAnimationPath = "";
    public String gLTFAnimation = "";
    ...
    protected void read(String[] split, TypeFile file) {
        try {
            ...
            } else if (split[0].equals("UseGLTFAnimation")) {
                useGLTFAnimation = Boolean.parseBoolean(split[1]);
            } else if (split[0].equals("UseRightArmGLTFAnimation")) {
                useRightArmGLTFAnimation = Boolean.parseBoolean(split[1]);
            } else if (split[0].equals("UseLeftArmGLTFAnimation")) {
                useLeftArmGLTFAnimation = Boolean.parseBoolean(split[1]);
            } else if (split[0].equals("GLTFAnimation")) {
                gLTFAnimation = split[1];
                gLTFAnimationPath = split[2];
                FlansMod.proxy.loadAnimation(gLTFAnimation, gLTFAnimationPath);
            } else if (split[0].equals("HideCrosshair") || split[0].equals("HideCrossHair")) {
                hideCrosshair = Boolean.parseBoolean(split[1]);
            }
    ...
    //This seems to always return "Material.ground", regardless of the input...
