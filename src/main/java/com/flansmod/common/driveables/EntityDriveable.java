...
//				checkParts();
    ...
    public void moveRiders(Entity rider) {
        ...
        if (rider.worldObj.isRemote) {
            if (isBulletTrackingActive) return;
        }
     ...
     * @param distanceDamageModifier
     */
    public float bulletHit(EntityBullet bullet, DriveableHit hit, float penetratingPower, double distanceDamageModifier) {
